...
public class CustomClassLoader extends ClassLoader {
    private final static Logger LOGGER =
            LoggerFactory.getLogger(CustomClassLoader.class.getName());
...
//                .collect(Collectors.toSet());
    ...
    private Class<?> loadClassFromFile(String name) throws MalformedURLException, ClassNotFoundException {
