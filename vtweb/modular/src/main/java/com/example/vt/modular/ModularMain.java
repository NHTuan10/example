...
public class ModularMain {
    public static void main(String[] args) {
        ...
        m.startSpringModuleSyncWithMainClassLoop("vt-plugin", "mvn://com.example/vt-plugin/0.0.1", "com.example.vt.plugin.Application", "com.example");
        m.startSpringModuleAsyncWithMainClassLoop("vt-plugin2", "mvn://com.example/vt-plugin-2/0.0.1", "com.example.vt.plugin2.Application", "*");
        m.startModuleAsync("vt-plugin-3-nospring", "mvn://com.example/vt-plugin-3-nospring/0.0.1", "*");
        m.startSpringModuleAsyncWithMainClass("vt-core", "mvn://com.example/vt-core/0.0.1", "com.example.vt.web.VtwebApplication", "com.example");
//        try {
//            m.startSpringModuleSyncWithMainClass("vt-core", "mvn://com.example/vt-core/0.0.1", "com.example.vt.web.VtwebApplication", "com.example");
//        }
//        catch (Exception e) {
//            e.printStackTrace();
//        }
...
//        testByteBuddy();
////        List<URL> depUrls = new MavenArtifactsResolver<URL>().resolveMavenDeps(List.of("com.example:vt-plugin:0.0.1"), URL.class);
...
//        new Thread(() -> {
//            try {
//                m.loadModule("vt-plugin", "mvn://com.example/vt-plugin/0.0.1", "com.example", true);
//                Thread.currentThread().setContextClassLoader(m.getClassLoader("vt-plugin"));
//                m.loadClass("vt-plugin", "com.example.vt.plugin.Application").getDeclaredMethod("main", String[].class).invoke(null, (Object) new String[]{});
...
//        new Thread(() -> {
////            try {
//            m.loadModule("vt-plugin-3-nospring", "mvn://com.example/vt-plugin-3-nospring/0.0.1", "com.example", false);
...
//        new Thread(() -> {
//            try {
//                m.loadModule("vt-plugin-2", "mvn://com.example/vt-plugin-2/0.0.1", "com.example", false);
//                Thread.currentThread().setContextClassLoader(m.getClassLoader("vt-plugin-2"));
//                m.loadClass("vt-plugin-2", "com.example.vt.plugin2.Application").getDeclaredMethod("main", String[].class).invoke(null, (Object) new String[]{});
//            } catch (ClassNotFoundException | InvocationTargetException | IllegalAccessException |
//                     NoSuchMethodException e) {
//                throw new RuntimeException(e);
//            }
...
//        new Thread(() -> {
//            try {
//                m.loadModule("vt-core", "mvn://com.example/vt-core/0.0.1", "com.example", false);
...
//
////        m.loadModule("vt-plugin-2", "mvn://com.example/vt-plugin-2/0.0.1", "com.example");
////        m.loadClass("vt-plugin-2", "com.example.vt.plugin2.Application").getDeclaredMethod("main", String[].class).invoke(null, (Object) new String[]{});
//
////        m.loadModule("vt-plugin", "mvn://com.example/vt-plugin/0.0.1");
//
